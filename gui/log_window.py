...
class LogWindow(tk.Toplevel):
    ...
    def __init__(self, master_app):
        ...
        self.log_text = tk.Text(main_frame, height=7, bg=self.master_app.style.lookup("TEntry", "fieldbackground"), fg=self.master_app.style.lookup("TEntry", "foreground"),
                                 insertbackground=self.master_app.style.lookup("TEntry", "insertcolor"), font=("Consolas", 10), state="disabled", wrap="none", relief="flat", borderwidth=1)
